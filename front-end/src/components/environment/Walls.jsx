  ...
  return (
    <group>
      ...
      <mesh position={[0, OUTFIELD_HEIGHT / 2, OUTFIELD_CENTER_Z]}>
        <cylinderGeometry
          args={[OUTFIELD_RADIUS, OUTFIELD_RADIUS, OUTFIELD_HEIGHT, 64, 1, true, Math.PI / 2, Math.PI]}
        />
        <meshLambertMaterial map={brickTexture} color="#35d9c6" side={DoubleSide} flatShading />
      </mesh>
      ...
      <mesh position={[-SIDE_MID_X, LOW_WALL_HEIGHT / 2, SIDE_MID_Z]}
            rotation={[0, -Math.PI / 4, 0]}>
        <boxGeometry args={[SIDE_WALL_LENGTH, LOW_WALL_HEIGHT, 1]} />
        <meshLambertMaterial map={brickTexture} color="#35d9c6"
...
export {
  ...
  BACKSTOP_RADIUS, LOW_WALL_HEIGHT,
}